                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <Label htmlFor="terms" className="text-sm leading-normal cursor-pointer">
                      Ich stimme den <Link to="/agb" className="text-secondary hover:underline">AGB</Link>, dem <Link to="/creator-vertrag" className="text-secondary hover:underline">Creator-Vertrag</Link> und der <Link to="/datenschutz" className="text-secondary hover:underline">Datenschutzerklärung</Link> zu. Ich bestätige, dass ich über 18 Jahre alt bin.
                    </Label>
                  </div>
                </div>
              )}
