    ...
    <div className="min-h-screen max-h-screen overflow-y-auto bg-background text-foreground p-4 md:p-8">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-4 text-muted-foreground">
          ...
          <h2 className="text-xl font-medium text-foreground">5. Identitäts- und Altersprüfung</h2>
          <p>
            <strong>Yoti:</strong> Um die Anforderungen des Jugendschutzes und des Digital Services Act (DSA) zu erfüllen, nutzen wir zur Identitäts- und Altersverifizierung den Dienst <strong>Yoti</strong> (Yoti Ltd., London, UK). Dabei werden Ihr Ausweisdokument und ggf. biometrische Daten zur Prüfung direkt an Yoti übermittelt. Wir erhalten lediglich das Verifizierungsergebnis sowie die zur Erfüllung gesetzlicher Pflichten erforderlichen Stammdaten (Name, Geburtsdatum). Eine dauerhafte Speicherung Ihrer Ausweisdokumente auf unseren Servern findet nicht statt.
          </p>
        </div>
      </div>
    </div>
